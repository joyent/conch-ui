                ...
                <div class="is-paddingless">
                    <div class="datatable-header">
                        ...
                        <a
                            ...
                            @click="showUpdatePhaseModal = true"
                            >Update Rack Phase</a
                        >
                        <a
                            class="button is-info"
                            @click="showEditLayoutModal = true"
                            >Edit Assignments</a
                        >
                    </div>
                    <table
            ...
            if (this.searchText) {
                ...
                devices = devices.reduce((acc, device) => {
                    if (
                        ...
                        search(
                            searchText,
                            device.device_asset_tag.toLowerCase()
                        )
                    ) {
                        acc.push(device);
                    } else if (
                        ...
                        search(
                            searchText,
                            device.hardware_product_name.toLowerCase()
                        )
                    ) {
                        acc.push(device);
                    } else if (
                        ...
                        search(
                            searchText,
                            device.device_serial_number.toLowerCase()
                        )
                    ) {
                        acc.push(device);
                    } else if (
