      ...
      <div class="container has-text-centered">
        ...
        >
          <div class="notification is-danger">
            ...
            <a class="is-size-7 help-link" @click="showHelp = !showHelp">
            ...
            <p class="api-version-help" v-if="showHelp">
              ...
              <strong class="has-text-white"> v{{ breakingApiVersion }} </strong
              >.
              <a
              ...
              <div class="columns">
                    ...
                    <form>
                      <div class="sign-in-input">
                        <div class="field">
                          ...
                          <div class="control has-icons-left">
                            ...
                            <span class="icon is-left">
                              ...
                              <i class="material-icons has-text-grey" v-else>
                                email
                              </i>
                            </span>
                          </div>
                        ...
                        <a
                          ...
                          @click="incompatibleApiVersion ? null : signIn()"
                ...
                <div class="column">
                  <div class="sign-in-image">
                    <img src="../../assets/secure_server.svg" />
                  </div>
                </div>
              </div>
            </div>
