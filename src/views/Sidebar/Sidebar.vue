  ...
  <aside class="menu" :class="{ loading: isEmpty(this.currentUser) }">
    ...
    >
      <router-link :to="{ name: 'builds' }" tag="div" class="brand">
        <img class="brand-icon" src="../../assets/brand.png" width="150px" />
      </router-link>
      <ul
        class="menu-list"
      ...
      >
        ...
        <li class="nav-item" v-if="currentUser.is_admin">
          <router-link :to="{ name: 'datacenters' }" active-class="is-active">
            <i class="material-icons">business</i>
            <span>Data Centers</span>
          </router-link>
        </li>
        <li class="nav-item" v-if="currentUser.is_admin">
          <router-link :to="{ name: 'devices' }" active-class="is-active">
            <i class="material-icons">dns</i>
            <span>Devices</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="{ name: 'organizations' }" active-class="is-active">
