<template>
  <div class="modal hardware-product-modal" :class="{ 'is-active': isActive }">
      ...
      <section class="modal-card-body">
        <form>
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" type="email" v-model="cpuType" />
            </div>
          </div>
          <div class="field">
            <label class="label">Hardware Vendor ID</label>
            <div class="control">
              <input class="input" type="email" v-model="hardwareVendorId" />
            </div>
          </div>
          <div class="field">
            <label class="label">BIOS Firmware</label>
            <div class="control">
              <input class="input" type="email" v-model="biosFirmware" />
            </div>
          </div>
          <div class="field">
            <label class="label">Purpose</label>
            <div class="control">
              <input class="input" type="email" v-model="purpose" />
            </div>
          </div>
          <div class="field">
            <label class="label">Validation Plan ID</label>
            <div class="control">
              <input class="input" type="email" v-model="validationPlanId" />
            </div>
          </div>
          <div class="field">
            <label class="label">Rack Unit Size</label>
            <div class="control">
              <input class="input" type="email" v-model="rackUnitSize" />
            </div>
          </div>
        </form>
      </section>
