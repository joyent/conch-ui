  ...
  <div class="create-token-modal">
    <div class="modal" :class="{ 'is-active': isActive }">
      ...
      <div class="modal-content">
        <div class="notification" v-if="!success">
          ...
          <div class="modal-body">
            ...
            <div
              class="control"
              :class="{
                'has-icons-left': emptyNameError || duplicateTokenError,
              }"
            >
              <input
                type="text"
                class="input"
                :class="{
                  'has-error': emptyNameError || duplicateTokenError,
                }"
                v-model="name"
              ...
              <p class="error-message has-text-danger" v-if="emptyNameError">
        ...
        <div class="notification" v-if="success && !tokenCopied">
          ...
          <div class="modal-body">
            <article class="notification success is-dark">
              ...
              Please store it where you will be able to find it later.
            </article>
            <textarea
              id="token"
        ...
        <div class="notification token-copied" v-if="success && tokenCopied">
          <div class="modal-heading">
            <i class="material-icons has-text-success">
              check_circle
            </i>
          ...
          .catch(error => {
            if (error.status === 400) {
              ...
              if (errorData && errorData.error) {
                if (
                  errorData.error.includes(`name "${name}" is already in use`)
                ) {
