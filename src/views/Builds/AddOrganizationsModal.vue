          ...
          <table class="table is-fullwidth">
            <tbody>
              ...
              <tr
                class="row item"
                :class="{
                  'is-selected': isOrganizationSelected(organization.id),
                }"
                v-for="organization in filteredOrganizations"
                :key="organization.id"
              >
                <template v-if="isOrganizationSelected(organization.id)">
                  <td class="item-name">
                  ...
                  <td class="role-select">
                    <div class="select role">
                      <select @change="updateRole(organization.id, $event)">
                        <option
                          value="admin"
    ...
    >
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <p>
            {{ selectedOrganizations.length }} organizations have been
            successfully added.
          </p>
          <br />
...
export default {
  ...
  computed: {
    ...mapState(['currentBuild', 'currentBuildOrganizations', 'organizations']),
