    ...
    <div class="modal-content notification">
      <div class="content-header">
        <p class="title has-text-weight-bold is-5">
          ...
          <i class="material-icons has-text-danger" v-if="serialNumberUnknown">
            error
          </i>
          <span v-if="isSuccess">Device Added Successfully</span>
          <span class="has-text-danger" v-else-if="serialNumberUnknown">
            Unknown Serial Number
          </span>
          <span class="has-text-warning" v-else-if="serialNumberDuplicated">
...
export default {
  ...
  computed: {
    ...
    setInputReadOnly() {
      return (
        this.isSuccess || this.serialNumberValidated || this.serialNumberUnknown
      );
    },
  },
};
