  ...
  <div class="overview-tab">
    ...
    <section class="info-tiles">
      <div class="tile is-ancestor has-text-centered">
        ...
        <div class="tile is-parent">
          <article class="tile is-child box">
            <p class="subtitle" style="margin-bottom: 10px">Hardware Product</p>
            <a
            ...
            >
              {{
                getHardwareProductName(activeDeviceDetails.hardware_product_id)
              }}
            </a>
          </article>
        </div>
      ...
      <div class="tile is-ancestor has-text-centered">
        <div class="tile is-parent is-vertical">
          ...
          <article class="tile is-child box uptime-since">
            ...
            <p class="title" v-if="activeDeviceDetails.uptime_since">
              {{ uptimeSince }}
            </p>
