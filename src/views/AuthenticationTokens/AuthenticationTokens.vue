      ...
      <div class="column" v-if="selectedUser && viewTokens">
        <div class="box selected-user" style="margin-bottom: 12px;">
          ...
          >
            ...
            <span class="title is-5 name is-marginless" style="flex-grow: 1;">
              {{ selectedUser.name }}
            </span>
            <a
            ...
            <div class="authentication-tokens-table">
              ...
              >
                ...
                <div class="table-filter">
                  ...
                  <div v-if="sortedTokens && sortedTokens.length">
                    <a
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="has-text-right" style="padding: 15px; 20px;">
                      <span
        ...
        <div v-if="sortedTokens && !sortedTokens.length" style="padding: 40px;">
          <p class="title no-tokens is-5 has-text-centered">
            <strong class="has-text-white">{{ selectedUser.name }}</strong>
...
export default {
  ...
  computed: {
    ...
    noSearchResultsUsers() {
      return (
        this.searchTextUsers && this.filteredUsers && !this.filteredUsers.length
      );
    },
  },
  created() {
