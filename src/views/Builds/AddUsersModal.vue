<template>
    <transition name="fade">
        ...
        <div
            class="add-users-success-modal modal"
            :class="{ 'is-active': isActive }"
            v-else
        >
            <div class="modal-background" @click="closeModal()"></div>
...
import { addUserToBuild } from '@api/builds.js';
...
export default {
    ...
    methods: {
        ...
        async addMembers() {
            ...
            EventBus.$emit('get-current-build');
        },
        addMember(user) {
            const role = { role: 'ro' };
